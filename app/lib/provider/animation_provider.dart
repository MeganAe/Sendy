// Modified for Sendy: honor the operating system reduced-motion preference.
...
final animationProvider = ViewProvider<bool>((ref) {
  ...
  final animations = enableAnimations && !sleeping && !reducedMotion;
