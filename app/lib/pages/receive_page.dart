// Modified for Sendy: branded consent page; original accept, decline and verification actions preserved.
import 'dart:async';
    ...
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        return PopScope(
          ...
          canPop: true,
          child: Scaffold(
            appBar: AppBar(title: const SendyLogo(size: 26)),
            body: SafeArea(
              child: Center(
                child: ConstrainedBox(
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      final smallUi = height < 650 || MediaQuery.textScalerOf(context).scale(16) > 24;
                      return Padding(
                                      ...
                                      if (vm.showSenderInfo && !smallUi)
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Icon(vm.sender.deviceType.icon, size: 44, color: Theme.of(context).colorScheme.primary),
                                          ),
                                        ),
                                      Builder(
                                        builder: (context) {
                                          ...
                                          if (alias.isEmpty) {
                                            return Text(
                                              '',
                                              style: TextStyle(fontSize: smallUi ? 24 : 32, fontWeight: FontWeight.w700),
                                            );
                                          }
                                          return FittedBox(
                                            child: Text(
