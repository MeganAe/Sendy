// Modified for Sendy: illustrated empty state for the existing reception history.
import 'dart:io';
        ...
        children: [
          ...
          if (entries.isEmpty)
            Padding(
              ...
              child: Column(
                children: [
                  const SendyLogo(size: 56, withText: false),
                  const SizedBox(height: 24),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    child: Text(t.receiveHistoryPage.empty, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleLarge),
                  ),
                ],
              ),
            )
