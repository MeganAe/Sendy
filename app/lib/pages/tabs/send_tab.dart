// Modified for Sendy: adaptive branded file selection header; existing transfer callbacks retained.
      ...
      builder: (context, vm) {
        ...
        final sections = <Widget>[
          SendySendHeader(
            ...
            onChoose: () async => ref.global.dispatchAsync(PickFileAction(option: FilePickerOption.file, context: context)),
          ),
          ...
          Row(
            key: const ValueKey('nearby-section'),
            children: [
          ...
          ...vm.nearbyDevices.map((device) {
            ...
            return InitialFadeTransition(
              key: ValueKey('sendy-device-${device.fingerprint}'),
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            final split = sections.indexWhere((widget) => widget.key == const ValueKey('nearby-section'));
            if (constraints.maxWidth >= 1000 && MediaQuery.textScalerOf(context).scale(16) <= 24) {
              return Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Expanded(
                    flex: 6,
                    child: ResponsiveListView(padding: EdgeInsets.zero, children: sections.sublist(0, split)),
                  ),
                  Expanded(
                    flex: 5,
                    child: ResponsiveListView(
                      padding: EdgeInsets.zero,
                      tabletPadding: const EdgeInsets.fromLTRB(0, 46, 16, 24),
            ...
            return ResponsiveListView(maxWidth: 780, padding: EdgeInsets.zero, children: sections);
          },
        );
      },
    );
      ...
      child: Material(
        ...
        child: DividerTheme(
          data: DividerThemeData(
            color: Theme.of(context).brightness == Brightness.light ? Theme.of(context).colorScheme.outlineVariant : Colors.grey.shade700,
          ),
