// Modified for Sendy: midnight/ivory tokens, accessible controls and rounded surfaces.
...
ThemeData getTheme(ColorMode colorMode, Color customColor, Brightness brightness, DynamicColors? dynamicColors) {
  ...
  return ThemeData(
    ...
    cardColor: brightness == Brightness.dark ? const Color(0xFF1B293D) : Colors.white,
    cardTheme: CardThemeData(
      elevation: 0,
      color: brightness == Brightness.dark ? const Color(0xFF1B293D) : Colors.white,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(SendyBrand.radius),
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      elevation: 0,
      labelTextStyle: WidgetStatePropertyAll(TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: colorScheme.onSurface)),
    ),
...
ColorScheme _determineColorScheme(ColorMode mode, Color customColor, Brightness brightness, DynamicColors? dynamicColors) {
  final defaultColorScheme = SendyBrand.scheme(brightness);
